...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str , help='The root path of the MVTec 3D-AD. The preprocessing is done inplace (i.e. the preprocessed dataset overrides the existing one)')
